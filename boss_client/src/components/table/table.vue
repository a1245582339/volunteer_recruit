  ...
  <div class="app-container">
    <el-table :data="list"  border fit highlight-current-row >
     <!-- 序列号 -->
      ...
      <!-- 价格 -->
      <el-table-column v-if="label.moudlePrice" :label="label.moudlePrice" width="150" align="center">
        <template slot-scope="scope">
          {{scope.row.price}}
        </template>
      </el-table-column>
     ...
     <el-table-column v-if="label.moudlePassword" :label="label.moudlePassword" width="110" align="center">
      ...
      <!-- 查看应召人 -->
      <el-table-column  v-if="label.showStu" :label="label.showStu" width="110" align="center">
        <template slot-scope="scope">
          <el-button
          @click="showList(scope.row.id)"
          type="text"
          size="small">
          查看
        </el-button>
