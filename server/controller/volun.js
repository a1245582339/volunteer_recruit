...
exports.VolunList = function(req, res, next) {
  req.models.volun.find({ isDel: 0 }, function(err, list) {
    console.log(err)
    if (err) {
      res.json({ code: -1 });
    } else {
      res.json({ title: "志愿者学生", code: 20000, data: list.reverse() });
    }
  });
};

// 审核学生
exports.CheckVolun = function(req, res, next) {
  var id = req.query[0];
...
// 删除学生
exports.DelVolun = function(req, res, next) {
...
// 修改学生
exports.UpdateVolun = function(req, res, next) {
  var id = req.body.id;
  req.models.volun
    .find({ id: id })
    .each(function(list) {
...
exports.CheckCurrentPassApi = function(req,res,next){
  ...
  req.models.volun.find({id:id},function(err,list){
...
exports.UpdatePassword = function(req,res,next){
  ...
  req.models.volun.find({id:id}).each(function(list){
